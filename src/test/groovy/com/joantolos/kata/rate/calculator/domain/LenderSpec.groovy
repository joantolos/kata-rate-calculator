...
class LenderSpec extends Specification {
    ...
    def 'Lender should be able to provide the final amount borrowed plus the interest' () {
    ...
    def 'Lender should be able to provide the final amount borrowed plus the interest with a larger amount' () {
